...
const materialien: Material[] = [
  {
    ...
    createdAt,
    updatedAt: "2026-07-08T06:45:00.000Z",
    projektId: projekt.id,
  ...
  },
  {
    ...
    kostenstelle: "KS-2026-0142",
    analyseQuelle: "erp",
    bauabschnitt: "Südfeld Bodenplatte",
    status: "nachgekauft",
    kostenProEinheitCent: 13800,
  },
  {
    id: "material-betonstahl-b500b",
    createdAt,
    updatedAt: "2026-07-08T08:10:00.000Z",
    projektId: projekt.id,
    name: "Betonstahl B500B Ø14",
    einheit: "t",
    geplant: 18.5,
    bestellt: 20,
    geliefert: 14.2,
    ...
    lager: 4.4,
    reserviert: 4.4,
    bauabschnitt: "Rohbau Decke OG1",
    analyseQuelle: "erp",
    status: "geliefert",
    kostenProEinheitCent: 118000,
  },
  {
    id: "material-kalksandstein-nf",
    createdAt,
    updatedAt: "2026-07-07T11:05:00.000Z",
    projektId: projekt.id,
    name: "Kalksandstein NF 24 cm",
    einheit: "stueck",
    geplant: 4200,
    bestellt: 4500,
    geliefert: 3200,
    ...
    lager: 350,
    reserviert: 200,
    bauabschnitt: "Innenausbau Schacht 2",
    analyseQuelle: "bau",
    status: "verbaut",
    kostenProEinheitCent: 285,
  },
  {
    id: "material-mineralfaser-daemmplatte",
    createdAt,
    updatedAt: "2026-07-08T05:30:00.000Z",
    projektId: projekt.id,
    name: "Mineralfaser-Dämmplatte WLG 035, 120 mm",
    einheit: "m2",
    geplant: 860,
    bestellt: 900,
    geliefert: 720,
    ...
    analyseQuelle: "planung",
    status: "geliefert",
    kostenProEinheitCent: 1890,
  },
  {
    id: "material-estrichmoertel",
    createdAt,
    updatedAt: "2026-07-06T16:40:00.000Z",
    projektId: projekt.id,
    ...
    lager: 26,
    reserviert: 26,
    bauabschnitt: "Innenausbau OG",
    analyseQuelle: "erp",
    status: "bestellt",
    kostenProEinheitCent: 14200,
  },
  {
    id: "material-trockenbau-profile",
    createdAt,
    updatedAt: "2026-07-08T07:55:00.000Z",
    projektId: projekt.id,
    name: "CW-Profil 75 mm (Trockenbau)",
    einheit: "m",
    geplant: 2400,
    bestellt: 2600,
    geliefert: 2100,
    ...
    lager: 420,
    reserviert: 300,
    bauabschnitt: "Innenausbau Cluster B",
    analyseQuelle: "bau",
    status: "geliefert",
    kostenProEinheitCent: 420,
  },
  {
    ...
    lager: 1,
    reserviert: 1,
    bauabschnitt: "Maschinenbau Werkstatt",
    analyseQuelle: "eap",
    status: "geliefert",
  ...
  },
  {
    ...
    projektId: projekt.id,
    name: "Dichtungssatz Hydraulikaggregat",
    einheit: "stueck",
    geplant: 2,
    bestellt: 2,
    geliefert: 2,
    ...
    reserviert: 1,
    veraltet: 1,
    bauabschnitt: "Betrieb Hydraulik",
    analyseQuelle: "betrieb",
    status: "kritisch",
    kostenProEinheitCent: 42000,
  },
  {
    id: "material-rohr-pehd",
    createdAt,
    updatedAt: "2026-07-08T09:20:00.000Z",
    projektId: projekt.id,
    name: "PE-HD Rohr DN 110 (TGA Entwässerung)",
    einheit: "m",
    geplant: 320,
    bestellt: 350,
    geliefert: 280,
    ...
    lager: 70,
    reserviert: 70,
    bauabschnitt: "TGA Rohinstallation",
    analyseQuelle: "erp",
    status: "geliefert",
    kostenProEinheitCent: 1850,
  },
]
...
const lagerArtikel: LagerArtikel[] = [
  ...
  },
  {
    ...
    createdAt,
    updatedAt: "2026-07-08T07:20:00.000Z",
    projektId: WBK_DEMO_PROJECT_ID,
  ...
  },
  {
    id: "lager-spannanker",
    createdAt,
    updatedAt: "2026-07-08T11:25:00.000Z",
    projektId: WBK_DEMO_PROJECT_ID,
  ...
  },
  {
    ...
    createdAt,
    updatedAt: "2026-07-08T11:50:00.000Z",
    projektId: WBK_DEMO_PROJECT_ID,
