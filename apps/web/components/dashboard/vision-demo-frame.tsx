...
export function VisionDemoFrame() {
  return (
    <svg
      ...
      role="img"
      aria-label="Demo-Baustellenaufnahme"
    ...
    >
      ...
      <rect x="120" y="300" width="420" height="180" fill="#6d7f86" opacity="0.85" />
      ...
      <rect x="860" y="384" width="200" height="96" fill="#b8c0c4" opacity="0.9" />
      <rect x="180" y="500" width="340" height="18" fill="#3d3028" opacity="0.7" />
      <rect x="520" y="470" width="220" height="14" fill="#3d3028" opacity="0.55" />
      <text
        x="48"
        y="64"
        fill="#1f2933"
      ...
      <text
        ...
        fontSize="18"
      >
        Demo-Frame fuer Live-Erkennung
      </text>
    </svg>
  )
}
